...
public class Path_3 {
    public static void begin() {
        ...
        StdDraw.text(0.5, 0.5, "You go towards the glade");
        StdDraw.pause(4000);
        StdDraw.clear();
        StdDraw.setPenColor(StdDraw.BLACK);
        StdDraw.filledSquare(0.5, 0.5, 0.5);
        StdDraw.setPenColor(StdDraw.WHITE);
        StdDraw.text(0.5, 0.5, "You can see more clearly now, as the moonlight illuminates your path");
        StdDraw.pause(4000);
        StdDraw.clear();
        StdDraw.setPenColor(StdDraw.BLACK);
        StdDraw.filledSquare(0.5, 0.5, 0.5);
        StdDraw.setPenColor(StdDraw.WHITE);
        StdDraw.text(0.5, 0.5, "You keep moving forward, but ends up tripping on something");
        StdDraw.pause(4000);
        StdDraw.clear();
        StdDraw.setPenColor(StdDraw.BLACK);
        StdDraw.filledSquare(0.5, 0.5, 0.5);
        ...
        StdDraw.filledSquare(0.5, 0.5, 0.5);
        StdDraw.setPenColor(StdDraw.WHITE);
        StdDraw.text(0.5, 0.8, "Do you keep it?");
        StdDraw.text(0.2, 0.5, "YES");
        StdDraw.text(0.8, 0.5, "NO");
    ...
    public static void YES() {
        ...
        StdDraw.filledSquare(0.5, 0.5, 0.5);
        StdDraw.setPenColor(StdDraw.WHITE);
        StdDraw.text(0.5, 0.5, "As soon as you touch it, you hear a scream coming from the forest");
        StdDraw.pause(4000);
        StdDraw.clear();
        StdDraw.setPenColor(StdDraw.BLACK);
        StdDraw.filledSquare(0.5, 0.5, 0.5);
