...
// ==============================================================================
    ...
    public static void main(String[] args) {
        ...
        enqueue(testQueue, referenceQueue, 7);
        enqueue(testQueue, referenceQueue, 10);

        System.out.println(testQueue.size() + " " + referenceQueue.size());
        System.out.println(testQueue.peek() + " " + referenceQueue.peek());
    ...
    private static void dequeue(AmhQueue<Integer> testQueue,
        ...
        System.out.println(testSuccess + " " + referenceSuccess);
        System.out.println(testValue + " " + referenceValue);
